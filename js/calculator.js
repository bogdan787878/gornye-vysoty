...
(function () {
  ...
  var TAB_INFO = {
    family:
      '<p class="gv-body-l">Семейная ипотека — особая льготная программа кредитования для семей:</p>' +
      '<ol class="gv-mortgage-info-list">' +
      '<li>с одним ребёнком в возрасте до 6 лет включительно</li>' +
      '<li>с ребёнком-инвалидом (до 18 лет)</li>' +
      '<li>с двумя и более несовершеннолетними детьми</li>' +
      '</ol>',
    matcap:
